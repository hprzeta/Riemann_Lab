> **Fichier :** 6_03_pave1-checklist_systeme_linux_hprzeta_v1_C.md · **Dossier :** wiki inbox-ia
> **Auteur :** hprzeta · **MAJ :** 2026-06-03

---

Riemann_Lab — Checklist système Linux avant
migration v1 — exigences Phase C
Cette version ajoute les exigences nécessaires pour compiler et exécuter Riemann_Lab_C : libmpfr, libgmp, gcc,
Makefile, multiprocessing, NumPy/CuPy optionnel.
...
cd ~/projet_zeta git branch -vv git status git diff --name-status Riemann_Lab_IA..Riemann_Lab_C git ls-tree -r --name-only
Riemann_Lab_C | grep -E "c_modules|compute_zeros_v4|illinois|benchmark|optimisation" find ~/projet_zeta -path "*/c_modules/*"
-maxdepth 8 -type f | sort find ~/projet_zeta/calculs -maxdepth 2 -type f | grep -E "20260511|20260521" | sort
...
• Un mini-run T=1000 v4.1 reproduit 649 ou le nombre attendu selon convention choisie, avec log complet et sans
doublons.
• Un benchmark documente clairement le gain réel C vs mpmath ; sans benchmark, le gain reste un objectif.

---
*6_03_pave1-checklist_systeme_linux_hprzeta_v1_C.md · inbox-ia · hprzeta · MAJ 2026-06-03*
